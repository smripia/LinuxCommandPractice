...
$ git branch -M main
$ git remote add origin git@github.com:{smripia}/LinuxCommandPractice.git
...
$ touch practice_dir_1/practice_dir_2/ptractice_file{1,2}.txt
